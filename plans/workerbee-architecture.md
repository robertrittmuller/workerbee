...
flowchart TB
    subgraph FastAPI [FastAPI Application]
        subgraph Routes [API Routes]
            AuthR[/auth endpoints]
            UserR[/users endpoints]
            WorkflowR[/workflows endpoints]
            AgentR[/agents endpoints]
            TaskR[/tasks endpoints]
            FileR[/files endpoints]
            OutputR[/outputs endpoints]
            SettingsR[/settings endpoints]
        end
        ...
        subgraph Models [Data Models]
            UserM[User Model]
            WorkflowM[Workflow Model]
            AgentM[Agent Model]
            TaskM[Task Model]
            FileM[File Model]
            OutputM[Output Model]
        end
